...
local HeroSkillChooseLayer = class("HeroSkillChooseLayer", function(params)
	return display.newLayer(GlobalRes .. "inner_bg.png")
end)

function HeroSkillChooseLayer:ctor(params)
	params = params or {}
...
function HeroSkillChooseLayer:listHeros()
